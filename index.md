...
- [[Maria Fernanda Lemos]] ("Mafé") — Analista Pleno, Produto, UX & Adoção de IA;
...
- [[Meeting prep - Agent Flow discovery with Mafé and João Victor - 2026-08-25]] — executa dois action items de [[2026-08-24 Agent Flow discovery with Carol]]: mapear onde vive o trabalho de [[Maria Fernanda Lemos]] (nenhum sistema) e o backlog CRM de [[João Victor Andrade]] (planilha pessoal). Tripla função agora — fonte de dados do A10 Portfolio, mapeamento de canal real de intake (A1 Receptor Universal), e **entender a prática real de A4 Teacher** através de Mafé, cujo cargo real (colado 2026-08-24) é literalmente o front de *Habilitadores de IA*.
