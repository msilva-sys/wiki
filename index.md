...
- [[Meeting prep - Agent Flow discovery with Carol - 2026-08-19]] — **reformulada 2026-08-24 como artefato de condução da reunião**: diagrama original (`sources/fluxo agêntico diagrama 0.png`, embutido diretamente) + tabela agente-a-agente (descrição da instrução do projeto, o que o Luís acha, o que a Gabi acha, com citações às meetings de origem). Sem ressalvas de leitura nem lista de perguntas — só o diagrama e a tabela. A5/Watcher aparece só como mais uma linha, com nota de que foi despriorizado — [[2026-08-24 Deprioritize A5 Watcher as first-agent candidate]].
