...
Root holds only `AGENTS.md`, `index.md`, `log.md`.
...
- **Frontmatter** on every page:
  ...
  **Exempt**: `AGENTS.md`, `index.md`, and `log.md` are infrastructure, not
  pages. They need no `status:` and `AGENTS.md` needs no frontmatter at all.
