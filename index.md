...
- [[2026-08-25 Farol - Dados]] — **transcrição de baixa confiança**: Gemini atribuiu a call inteira à Carolina Bezerra, mas o conteúdo é claramente duas vozes (atribuição inferida por conteúdo, não diarizada — provavelmente Luís explicando a arquitetura, Carolina questionando prioridade). Decisões: Airtable descartado por volume (~750k registros/ano vs. cap Enterprise de ~500k); Marina (financeiro) recebe repo + cópia do banco, time de dados mantém a ingestão/dedup. Opinião de Carolina sobre a baixa prioridade do Farol se repete, independente, de uma conversa diferente em 2026-08-24.
