...
## Syntheses
- [[Como implementar a PoC do A10+A14 (LangGraph, Skill, Agent SDK)]] — desenho da PoC de [[2026-08-24 Build A10 and A14 together, PoC first]], resultado de brainstorm em chat 2026-08-26: três frentes leves (LangGraph, Skill do Claude Code, Claude Agent SDK), nenhuma "principal"; caso de teste é o Farol, não a reunião inteira com a Carol; objetivo virou "algo palpável + opções", não "framework é necessário".
