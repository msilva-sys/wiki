...
- [[2026-08-24 Build A10 and A14 together, PoC first]] — M1's scope: A10 Portfolio and A14 PM Agent build together, gated by a PoC extending Luís's already-tasked LangGraph-vs-Claude-Code prototype. Two specs (actor→input→output each), one build; A14 scoped down since its full spec presupposes a pipeline that doesn't exist yet.
