...
- [[Meeting prep - Agent Flow discovery with Carol - 2026-08-19]] — **reformulada 2026-08-24 como artefato de condução da reunião**: diagrama original (`sources/fluxo agêntico diagrama 0.png`, embutido diretamente — substitui a recriação em Mermaid da primeira passada) + tabela agente-a-agente (descrição da instrução do projeto, o que o Luís acha, o que a Gabi acha, com citações às meetings de origem), substituindo a versão anterior por temas isolados. Fecha com uma lista curta de perguntas pra levar (as duas dores do msilva, ferramenta de intranet = A10?, limite do repositório de skills vs. A6, minimalismo de contexto, apetite de ritmo da Carol pra memória — pedido do Luís). A5/Watcher aparece só como mais uma linha, com nota de que foi despriorizado — [[2026-08-24 Deprioritize A5 Watcher as first-agent candidate]]. Sem registro de que a conversa com a Carol já ocorreu.
