...
> [!tip] A10 para de expor detalhe de issue, encaminha pro A14 — Luís, 2026-09-02, implementado mesmo dia
...
> dele.
>
> **Implementado e testado no mesmo dia**: digest publicado, dashboard e chat
> do A10 pararam de expor issue específica — só agregado (contagem por
> critério, tendência, concentração de carga); pergunta de issue específica
> no chat é redirecionada pro A14. A leitura interna de issues cruas não
> mudou, só o que é exposto. Detalhe completo, arquivos mexidos e teste ao
> vivo do redirecionamento:
> [[2026-09-02 A10 para de expor detalhe de issue, encaminha pro A14]].
>
> **Nuance que essa implementação não fecha**: msilva ainda tinha pedido que
> Luís trouxesse fontes e argumentos (inclusive resposta de IA "crua," sem
> viés) pra embasar a fronteira PM vs. Portfolio antes de fechar a **direção
> de produto** do A10/A14 — isso ainda não foi recebido. O que foi
