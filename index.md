...
- [[Meeting prep - Agent Flow discovery with Carol - 2026-08-19]] — general Agent Flow discovery agenda, not limited to one agent (**renamed 2026-08-19 from "A5 Watcher discovery" at msilva's direction** — that was too narrow). Covers which-agent-first against her own-pain criterion, the Watcher/A5 discovery question (asked cold, per [[2026-08-18 1-1 Matheus - Luís]]), A6-vs-her-skills-repo overlap, her intranet tool as a possible A10, and getting her context-minimalism view first-hand.
